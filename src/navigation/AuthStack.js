...
//    load()
 ...
 {splashShow?<Stack.Screen name={navigationStrings.Splash} component={Splash}/>:null}
     ...
     <Stack.Screen name={navigationStrings.StartPage} component={StartPage} />
    ...
    <Stack.Screen name={navigationStrings.CompletePay} component={CompletePay} options={{headerShown:true,headerTitle:'Complete Payment'}} />
